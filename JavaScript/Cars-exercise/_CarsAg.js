...
function getAgencyByName(str) {
  return carMarket.sellers.find((x) => x.agencyName === str);
}
...
// }
const getAgencyIdByName = () => {};
carMarket.getAgencyIdByName = function (name) {
  //this.sellers = [] Its an array so we can use method
  const agency = this.sellers.find((agencyObject) => {
    return name === agencyObject.name;
  });
...
// function getAllAgenciesName(str) {}
